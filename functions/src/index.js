...
exports.addmessage = (0, https_1.onRequest)(function (req, res) {
    ...
    return __generator(this, function (_a) {
      switch (_a.label) {
        case 0:
          return [
            4 /*yield*/,
            (0, firestore_2.addDoc)((0, firestore_2.collection)(db, 'events'), {
              name: 'テストだよ〜2',
              candidateDates: [
                {
                  date: '2022-01-01',
...
exports.makeuppercase = (0, firestore_1.onDocumentCreated)(
  '/messages/{documentId}',
  function (event) {
